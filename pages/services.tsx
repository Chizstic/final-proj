...
const services: Service[] = [
  { id: 1, title: "Hair Trim", description: "Professional haircuts for a fresh look.", image: "/SO_img1.png", price: "₱150" },
  { id: 2, title: "Hair Color", description: "Vibrant hair color tailored to you.", image: "/SO_img2.png", price: "₱1,699" },
  { id: 3, title: "Hot Oil", description: "Nourishing treatment for shiny, healthy hair.", image: "/SO_img3.png", price: "₱1,999" },
  { id: 4, title: "Balayage", description: "Natural, hand-painted highlights.", image: "/SO_img4.png", price: "₱1,699" },
  { id: 5, title: "Hair Rebond", description: "Straighten and smoothen frizzy hair.", image: "/SO_img5.png", price: "₱1,499" },
  { id: 6, title: "Hair Botox", description: "Revitalize hair with deep conditioning.", image: "/SO_img6.png", price: "₱1,599" },
  { id: 7, title: "Keratin", description: "Silky, frizz-free hair treatment.", image: "/SO_img7.png", price: "₱1,699" },
  { id: 8, title: "Highlights", description: "Accentuate with natural-looking highlights.", image: "/SO_img8.png", price: "₱1,799" },
  { id: 9, title: "Foot Spa", description: "Relax and rejuvenate your feet.", image: "/SO_img9.png", price: "₱299" },
  { id: 10, title: "Foot Massage", description: "Relaxing massage to relieve foot tension.", image: "/SO_img10.png", price: "₱199" },
  { id: 11, title: "Waxing (Armpit & Legs)", description: "Smooth and hair-free skin.", image: "/SO_img11.png", price: "₱199" },
  { id: 12, title: "Hair Styling", description: "Glamorous styles for any occasion.", image: "/SO_img12.png", price: "₱499" },
  { id: 13, title: "Makeup", description: "Flawless makeup for special events.", image: "/SO_img13.png", price: "₱599" },
  { id: 14, title: "Manicure", description: "Elegant nail shaping and polish.", image: "/SO_img14.png", price: "₱199" },
  { id: 15, title: "Pedicure", description: "Relaxing nail and foot care.", image: "/SO_img15.png", price: "₱199" },
  { id: 16, title: "Nail Gel", description: "Glossy, durable nail coating.", image: "/SO_img16.png", price: "₱349" },
  { id: 17, title: "Gel Polish", description: "Long-lasting, chip-resistant polish.", image: "/SO_img17.png", price: "₱449" },
  { id: 18, title: "Soft Gel Nail Extension", description: "Extend nails with natural-looking gel.", image: "/SO_img18.png", price: "₱459" },
];
